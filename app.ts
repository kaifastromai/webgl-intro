...
var pos_x_slider: HTMLInputElement = <HTMLInputElement>document.getElementById('pos_x_slider');
var pos_y_slider: HTMLInputElement = <HTMLInputElement>document.getElementById('pos_y_slider');
